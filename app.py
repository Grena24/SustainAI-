...
if page == "Input & Prediction":
    ...
    # 2. Radar Chart for Current Product
    ...
    normalized_values = [
        (carbon / max_values['Carbon_Footprint']) * 100,
        (energy / max_values['Energy_Consumption']) * 100,
        (water / max_values['Water_Usage']) * 100,
        (waste / max_values['Waste_Generated']) * 100,
        (weight / max_values['Weight']) * 100
    ]
    ...
    fig_radar.add_trace(go.Scatterpolar(
        r=normalized_values,
        theta=['Carbon Footprint', 'Energy Consumption', 'Water Usage', 'Waste Generated', 'Weight'],
        fill='toself',
        name=f'{product_name}',
        line_color='#FF6B6B'
    ))
    ...
    fig_material = px.scatter_3d(
        ...
        title="3D Material Impact Analysis"
    )
